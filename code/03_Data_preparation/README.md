...
* [`01_build_objects.R`](03_Data_preparation/01_build_objects.R): 
    ...
    * **3\.  Feature filtering**: Lowly-expressed genes were filtered out. Additional QC metrics and sample filtering info from [`04_EDA/01_QCA.R`](04_EDA/01_QCA.R) analysis were included in these filtered and normalized datasets.
