...
* [`01_enrich_DEGs_vs_cell_type_markers.R`](01_enrich_DEGs_vs_cell_type_markers.R): 
    ...
    * **1\. Obtain cell type marker genes in rodent habenula and amygdala**: 
        ...
        * *1\.2 Obtain cell type marker genes in rat amygdala*: snRNA-seq data from Zhou, J., et al. (2023) were explored and log-norm counts were used to find *MeanRatio* and *1vsALL* markers [TODO].
    
        ***Note***: for human habenula and amygdala cell type markers were obtained and provided by [Louise Huuki-Myers](https://lahuuki.github.io) and [Michael Totty](https://github.com/MicTott), respectively. 
    ...
    * **3\. Compare *MeanRatio* vs *1vsALL* marker genes**: the ratio of *MeanRatio* marker genes for broad and fine human cell types, for all and neuronal mouse cell types, and [] and [] rat amygdlaa cell types, was compared against their *1vsALL* standard logFC (aka *t*-stats) for the same or equivalent cell types, identifying common markers with both methods, for both habenula and amygdala cell types in human and mouse.  
