...
The association between the differential expression of genes in rat habenula and amygdala after fentanyl self-administration and their cell type-specific expression was assessed based on the enrichment among such rat habenula and amygdala DEGs, of rat marker genes for main and fine amygdala cell types, and rat orthologs of human marker genes for epithalamus (including the habenula) and amygdala cell types at broad and fine resolutions, as well as mouse marker genes for all or only neuronal cell subpopulations of the habenula complex.
...
* [`01_enrich_DEGs_vs_cell_type_markers.R`](01_enrich_DEGs_vs_cell_type_markers.R): 
    ...
    * **1\. Obtain cell type marker genes in rodent habenula and amygdala**: 
        ...
        * *1\.2 Obtain cell type marker genes in rat amygdala*: snRNA-seq data from Zhou, J., et al. (2023) were explored and normalized counts were used to find *MeanRatio* and *1vsALL* markers for main cell types and Inhib. neuronal subtypes.
    ...
    * **3\. Compare *MeanRatio* vs *1vsALL* marker genes**: the ratio of *MeanRatio* marker genes for broad and fine human cell types, for all and neuronal mouse cell types, and for main and fine rat amygdala cell types, was compared against their *1vsALL* standard logFC (aka *t*-stats) for the same or equivalent cell types, identifying common markers with both methods.
