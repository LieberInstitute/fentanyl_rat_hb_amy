...
Cell type marker genes in human epithalamus and amygdala were obtained applying the *MeanRatio* and *1vsALL* methods -described in [Huuki-Myers, L., et al. (2024) ](https://doi.org/10.1101/2024.02.09.579665)- using snRNA-seq data from [Yalcinbas, E., et al. (2024)](10.1101/2024.02.26.582081) and [Yu, B., et al. (2023)]( https://doi.org/10.1038/s41421-022-00506-y), respectively. The following were the sets of markers used:
